...
const CustomSelection = ({
  ...
  return (
    <View className="w-full bg-blue-300">
        <Text>hlsdfjksldjfl</Text>
    </View>
    )
          ...
          <Formik
            ...
            onSubmit={(values) => {
              if (values) {
                ...
                setCustomProductId({
                  id: "gid://shopify/ProductVariant/12528927113333",
                  type: "text-with-graphics",
                  title: "Text-Graphics",
                  price: "150",
                  selections: [{ ...values }],
...
const HeaderTitle = ({ title }) => {
  return (
    <Text className="text-[20px] text-green-500 font-normal uppercase text-center">
      {title}
    </Text>
  );
};

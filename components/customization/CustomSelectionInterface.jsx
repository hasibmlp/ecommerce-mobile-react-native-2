...
const CustomSelectionInterface = ({
  totalCustom,
  setTotalCustom,
  onClose,
  customProductId,
        ...
        <View>
          <View className="w-full h-[200] bg-gray-200">
            <Image
              ...
              src="https://img.freepik.com/premium-vector/cute-pattern-small-colorful-flowers-dark-blue-background-seamless-floral-pattern_264287-269.jpg"
            />
          </View>
          ...
          <View className="py-5">
            <Text
              ...
              className="text-[16px] text-black font-medium px-5 uppercase pb-5"
            >
              Embriodery
            </Text>
            <Text
              style={FONT_FAMILY.primary}
              className="text-[16px] text-black font-medium text-center pb-10"
            >
              Choose an embroidery option
            </Text>
            <View className="w-[90%] mx-auto h-full items-center">
              ...
              <View className="w-full">
                <Button
                  onPress={() => handleSelection("text-only")}
                  label="Text Only"
                  type="secondary"
                  active={
                    cusotmSelections
                      ? cusotmSelections.type === "text-only"
                      : true
                  }
                  colors={["green", "lightgray"]}
                  textColors={["#32cd32", "#d3d3d3"]}
                />
                <Button
                  onPress={() => handleSelection("graphics-only")}
                  label="Graphics Only"
                  type="secondary"
                  style={{ marginTop: 24 }}
                  active={
                    cusotmSelections
                      ? cusotmSelections.type === "graphics-only"
                      : true
                  }
                  colors={["green", "lightgray"]}
                  textColors={["#32cd32", "#d3d3d3"]}
                />
                <Button
                  onPress={() => handleSelection("text-with-grahpics")}
                  label="Text & Graphics"
                  type="secondary"
                  style={{ marginTop: 24 }}
                  active={
                    cusotmSelections
                      ? cusotmSelections.type === "text-with-graphics"
                      : true
                  }
                  colors={["green", "lightgray"]}
                  textColors={["#32cd32", "#d3d3d3"]}

...
export default function ThreeCategoryBlock({content}) {
    ...
    return (
      <View className="py-2 bg-white">
        {(content.data.subTitle || content.data.title || content.data.desc || content.data.cta) && (<View className="items-center py-4 gap-1 bg-white">
        ...
        <View className="flex-row gap-1">
          <View style={{height: content.data.height}} className={`flex-1 justify-end`}>
            ...
            {content.data.images[0].title && (
              ...
              className="w-full h-[80px] items-center justify-end">
                <Text className="text-[16px] font-medium text-white pb-[20px] uppercase text-center">
                  {content.data.images[0].title}
                </Text>
              </LinearGradient>
            )}
          ...
          <View style={{height: content.data.height}} className={`flex-1 justify-end`}>
            <Image className="w-full h-full absolute left-0 top-0" src={content.data.images[2].url} />
